...
class Student:
    def __init__(self,root):
        ...
        self.var_radio1=StringVar()
         ...
         #first image
        img=Image.open(r"C:\Users\Sony\Desktop\face recognition system\college_images\student1.jpeg")
        ...
        #second image
        img1=Image.open(r"C:\Users\Sony\Desktop\face recognition system\college_images\student2.jpeg")
        ...
        #third image
        img2=Image.open(r"C:\Users\Sony\Desktop\face recognition system\college_images\student1.jpeg")
        ...
        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",15,"bold"),bg="orange",fg="white")
        title_lbl.place(x=0,y=0,width=1530,height=20)

        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=0,y=20,width=1480,height=800)
       ...
       #current course
        ...
        current_course_frame.place(x=5,y=105,width=640,height=110)
      #department
      ...
      #class student information
        ...
        class_student_frame.place(x=5,y=215,width=640,height=290)
    ...
    #class division
        ...
        classdivision_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman",12,"bold"),state='readonly',width=20)
        classdivision_combo["values"]=("Select division","A",'B','C','D')
   ...
   #address
     ...
     #teacher name
        tname_label=Label(class_student_frame,text="teacher name:",font=("times new roman",13,"bold"),bg="white")
      ...
      #RADIO BUTTONS
        ...
        radiobtn1=ttk.Radiobutton(class_student_frame,variable=self.var_radio1,text="Take photo sample",value="no")
    ...
    # bbuttons frame
        ...
        save_btn=Button(btn_frame,text='save',command=self.add_data,width=15,font=('times new roman',13,'bold'),bg='violet',fg='white')
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text='update',command=self.update_data,width=15,font=('times new roman',13,'bold'),bg='violet',fg='white')
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text='delete',command=self.delete__data,width=15,font=('times new roman',13,'bold'),bg='violet',fg='white')
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,text='reset',command=self.reset_data,width=15,font=('times new roman',13,'bold'),bg='violet',fg='white')
    ...
    #right label frame
        ...
        img_right=Image.open(r"C:\Users\Sony\Desktop\face recognition system\college_images\student1.jpeg")
        img_right=img_right.resize((500,100),Image.ANTIALIAS)
        ...
        search_label=Label(search_frame,text="search by:",font=("times new roman",15,"bold"),bg="violet",fg='white')
        ...
        table_frame.place(x=5,y=180,width=577,height=319)

        scroll_x=ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_frame,orient=VERTICAL)

        self.student_table=ttk.Treeview(table_frame,column=('dep','course','year','sem','id','name','div','roll','gender','dob','email','phoneno','address','teacher name','photo'),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.student_table.heading('teacher name',text='Teacher')
...
#==========================function declaration================================================
    def add_data(self):
      if self.var_dep.get()=='Select Department' or self.var_std_name.get()=="" or self.var_std_id.get()=="":
        ...
        try:
            conn=mysql.connector.connect(host='localhost',username='root',password='Aa123@123',database='face_recognition')
            ...
            try:
                  ...
                  if update>0:
                    ...
                    my_cursor.execute('update student set Dep=%s,course=%s,year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s',(
                     ...
                     if not update:
                              return 
                  messagebox.showinfo('Success','student detais successfully update completed',parent=self.root)
                  conn.commit()
                  self.fetch_data()
                  conn.close()
            except Exception as es:
